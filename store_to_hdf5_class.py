...
class HDF5Store(object):
	...
	Originally from https://gist.github.com/wassname/a0a75f133831eed1113d052c67cf8633
	"""
	...
	with h5py.File(self.datapath, mode='w') as h5f:
		self.dset = h5f.create_dataset(
			dataset, shape=(0, ) + shape, maxshape=(None, ) + shape, dtype=dtype,
			compression=compression, chunks=(chunk_len, ) + shape)
	#
